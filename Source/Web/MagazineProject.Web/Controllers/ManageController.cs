namespace MagazineProject.Web.Controllers
{
    ...
    using MagazineProject.Web.Models.Manage;
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                this.TempData["Message"] = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert'>&times;</a><strong>Success!</strong> Successfully Change Password.</div> ";

                return this.RedirectToAction("Index", new { controller = "Profile", area = "Users", Message = "Success"});
            }

            this.TempData["Message"] = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert'>&times;</a><strong>Success!</strong> Successfully Add Comment.</div> ";
